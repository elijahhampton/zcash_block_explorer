...
export default () => {
  ...
  return (
    <Box display="flex" justifyContent="space-between">
      ...
      >
        <DrawerHeader />
        <Typography variant="h6" sx={{ color: "#3e5a5b" }}>
          Block Details
        </Typography>
        <List disablePadding>
            ...
            <ListItemText
              ...
              secondary={
                <ListItemDetailSecondaryTypography>
                  jdsf98h9p9w8sey98s7ryt87sy49ay40t9wu34ut0349ut0349ut
                </ListItemDetailSecondaryTypography>
              }
            />
          </ListItem>
      ...
      <Box sx={{ pt: 3, px: 4, height: "100%", width: "70%", float: "right" }}>
        ...
        <Stack spacing={4}>
          <div>
            <Typography variant="h6" sx={{ color: "#3e5a5b", pb: 2, pt: 0.5 }}>
              Block Information
            </Typography>
